      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a
              href="#contact"
              className="border border-blue-500/50 text-blue-400 py-3 px-6 rounded font-medium transition-all duration-200 hover:bg-blue-500/10 hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] hover:-translate-y-0.5"
            >
              Contact Me
            </a>
          </div>
